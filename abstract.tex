...
We show how accounting for downstream analytics operations during dimensionality reduction via PCA allows stochastic methods to efficiently operate over very small (e.g., 1\%) subsamples of input data, thus reducing computational overhead and end-to-end runtime. 
